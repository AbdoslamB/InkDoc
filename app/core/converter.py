...
def convert_item(item: QueueItem, options: ConversionOptions) -> str:
    ...
    If the item or options specifies EngineKind.DOCLING, routes through Docling.
    Otherwise, runs the standard Microsoft MarkItDown conversion completely unchanged.
    """
